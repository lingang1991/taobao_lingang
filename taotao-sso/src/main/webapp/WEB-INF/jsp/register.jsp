...
<body>
		...
		<div class="mc">
			<form id="personRegForm" method="post" onsubmit="return false;">
				<div class="form" onselectstart="return false;">
					...
					<div class="item" id="d_email">
						<span class="label"><b class="ftx04">*</b>验证邮箱：</span>

						<div class="fl item-ifo">
							<input type="text" id="email" maxlength="28" name="email"
								class="text" tabindex="4" autocomplete="off" /> <i
								class="i-email"></i> <label id="email_succeed" class="blank"></label>
	...
	var REGISTER={
		...
		doSubmit:function() {
			//做post请求，携带参数，其中$("#personRegForm").serialize()是将表单内容序列号
